...
[![Build status](https://github.com/axkr/symja_android_library/actions/workflows/maven-build-master-and-publish-snapshot/badge.svg)](https://github.com/axkr/symja_android_library/actions/workflows/maven-build-master-and-publish-snapshot.yml)
[![Maven Central](https://img.shields.io/maven-central/v/org.matheclipse/matheclipse)](https://search.maven.org/search?q=a:matheclipse)
[![Snapshot](https://img.shields.io/nexus/s/https/oss.sonatype.org/org.matheclipse/matheclipse.svg)](https://oss.sonatype.org/content/repositories/snapshots/org/matheclipse/matheclipse/)
